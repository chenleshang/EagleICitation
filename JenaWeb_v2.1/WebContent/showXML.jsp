...
<body>
<%
String citeResult = (String)session.getAttribute("XMLResult");
...
<TABLE style="border:1px dashed black;" SIZE=1000 HEIGHT=100 bgcolor="#D3D3D3"; align="center">
<TR><TD><xmp><%=citeResult %></xmp></TD></TR></TABLE>
</div>
...
<a href="showCitation.jsp"><img alt="" src="http://dblp.uni-trier.de/img/download.dark.hollow.16x16.png" class="icon">Citation</a> 
